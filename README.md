...
# News: MedTem1.0 entitled "Extraction of Medication and Temporal Relation from Clinical Text using Neural Language Models" is accepted to 'Workshop on Big Data Analytic in Healthcare' In conjunction with the 2023 IEEE International Conference on Big Data (http://bigdataieee.org/BigData2023/) December 15-18, 2023 – Sorrento, Italy

# MedTem1.0: [codes used](https://github.com/HECTA-UoM/MedTem/blob/main/MedTem1.zip)
Abstract:
